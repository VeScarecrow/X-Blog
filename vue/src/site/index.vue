                    ...
                    <div class="post-list-item" v-for="item in list">
                        <div class="post-list-item-container">
                            <div class="item-thumb bg-deepgrey"
                                 :style="'background-image:url(' + item.title_pic + ');'"></div>
                            <router-link :to="'/article/' + item.id">
                                <div class="item-desc">
                                    <p v-text="delHtmlTag(item.content)"/>
                                </div>
                            </router-link>
                            ...
                            <div class="item-label">
                                ...
                                <div class="item-meta clearfix">
                                    <div class="item-meta-ico bg-ico-note"
                                         style="background: url(http://cdn.tycoding.cn/tumo-bg-ico.png) no-repeat;background-size: 40px auto;"></div>
            ...
            <div class="lists-navigator clearfix">
                <ol class="page-navigator">
                    <li class="prev" v-if="listQuery.pageCode !== '1'">
                        <router-link
                            :to="'/page/' + ((listQuery.pageCode < 1) ? listQuery.pageCode : (listQuery.pageCode-1))">←
                        </router-link>
                    </li>
                    <li v-for="i in total">
                        <router-link :style="i === listQuery.pageCode ? 'color: #eb5055;' : ''" :to="'/page/' + i"
                                     v-text="i"/>
                    </li>
                    <li class="next" v-if="listQuery.pageCode < total">
                        <router-link :to="'/page/' + ((listQuery.pageCode < total) ? (listQuery.pageCode+1) : total)">
                            →
                        </router-link>
                    </li>
                </ol>
