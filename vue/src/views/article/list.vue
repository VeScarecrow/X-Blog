<template>
    <div class="editor-container">
        ...
        <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%">
            ...
            <el-table-column align="center" prop="edit_time" label="最后编辑时间" width="170"></el-table-column>
            <el-table-column align="center" prop="publish_time" label="发布时间" width="170"></el-table-column>
            ...
            <el-table-column align="center" prop="state" label="状态" width="120">
                <template slot-scope="scope">
                    <el-tag>{{scope.row.state == 'published' ? '已发布':'存入草稿'}}</el-tag>
                </template>
            </el-table-column>
